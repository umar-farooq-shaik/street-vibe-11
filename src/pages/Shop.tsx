...
const Shop = () => {
  ...
  const products = [
  // 1st card - Premium Leather Aviator Jacket
  {
    id: 201,
    name: "Premium Leather Aviator Jacket",
    price: 299,
    category: "jackets",
    image: "https://images.unsplash.com/photo-1520975954732-35dd22299614?w=500&h=500&fit=crop&crop=center",
    rating: 4.9,
    reviews: 312
  },
  // 2nd card - Embroidered Hoodie
  {
    id: 12,
    name: "Embroidered Hoodie",
    price: 115,
    category: "hoodies",
    image: "https://images.unsplash.com/photo-1564557287817-3785e38ec1f5?w=500&h=500&fit=crop&crop=center",
    rating: 4.8,
    reviews: 189
  },
  // 3rd card - Leather Biker Jacket
  {
    id: 42,
  ...
  {
    id: 204,
    name: "Limited Edition Basketball Shoes",
    price: 199,
    category: "sneakers",
    image: "https://images.unsplash.com/photo-1460353581641-37baddab0fa2?w=500&h=500&fit=crop&crop=center",
    rating: 4.9,
    reviews: 523
  },
  ...
  // Hoodies (12 products - removed embroidered hoodie as it's moved to 2nd position)
  {
    id: 1,
  ...
  // 12th card - Designer High-Top Sneakers
  {
    id: 202,
    ...
    id: 13,
    name: "Japanese Text Hoodie",
    price: 94,
    category: "hoodies",
    image: "https://images.unsplash.com/photo-1516762689617-e1cffcef479d?w=500&h=500&fit=crop&crop=center",
    rating: 4.5,
    reviews: 76
  }, {
    id: 14,
  ...
  // Sneakers (12 products - removed designer high-top as it's moved to 12th position)
  {
    id: 19,
    ...
    price: 129,
    category: "sneakers",
    image: "https://images.unsplash.com/photo-1520256862855-398228c41684?w=500&h=500&fit=crop&crop=center",
    rating: 4.7,
    reviews: 178
  }, {
    id: 27,
    ...
    id: 29,
    name: "Vintage Suede Sneakers",
    price: 119,
    category: "sneakers",
    image: "https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?w=500&h=500&fit=crop&crop=center",
    rating: 4.7,
    reviews: 167
  }, {
    id: 30,
    ...
    price: 139,
    category: "sneakers",
    image: "https://images.unsplash.com/photo-1543508282-6319a3e2621f?w=500&h=500&fit=crop&crop=center",
    rating: 4.9,
    reviews: 223
  }, {
    id: 34,
    ...
    price: 99,
    category: "sneakers",
    image: "https://images.unsplash.com/photo-1514989940723-e8e51635b782?w=500&h=500&fit=crop&crop=center",
    rating: 4.4,
    reviews: 87
  }, {
    id: 36,
    name: "Designer Collaboration Sneakers",
    price: 299,
    category: "sneakers",
    image: "https://images.unsplash.com/photo-1584735175315-9d5df23860e6?w=500&h=500&fit=crop&crop=center",
    rating: 4.9,
    reviews: 312
  },
  // Jackets (11 products - removed leather biker jacket as it's moved to 3rd position)
  {
    id: 39,
    ...
    price: 109,
    category: "jackets",
    image: "https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?w=500&h=500&fit=crop&crop=center",
    rating: 4.6,
    reviews: 145
  }, {
    id: 46,
    ...
    price: 89,
    category: "jackets",
    image: "https://images.unsplash.com/photo-1620799140188-3b2a02fd9a77?w=500&h=500&fit=crop&crop=center",
    rating: 4.5,
    reviews: 123
  }, {
    id: 47,
    ...
    price: 99,
    category: "jackets",
    image: "https://images.unsplash.com/photo-1562572159-4efc207f5aff?w=500&h=500&fit=crop&crop=center",
    rating: 4.4,
    reviews: 89
  }, {
    id: 50,
  ...
  // Jeans (13 products - removed cropped jeans as it's moved to 4th position)
  {
    id: 52,
  ...
  // Shirts (23 products - removed casual button shirt as it's moved to 5th position)
  {
    id: 68,
  ...
  return <div className="min-h-screen bg-white-smoke">
      <Navbar />
      
      {/* Page Header - increased padding */}
      <motion.div className="pt-20 pb-12 bg-gradient-dark" initial={{
      opacity: 0
    }} animate={{
      opacity: 1
    }} transition={{
      duration: 0.6
        ...
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 my-[10px]">
      ...
      <div id="products-section" className="container mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Filters Sidebar */}
          <motion.div className="lg:w-1/4" initial={{
          x: -50,
          opacity: 0
        }} animate={{
          x: 0,
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input type="text" placeholder="Search products..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-neon-green focus:border-transparent" />
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  {categories.map(category => <label key={category.id} className="flex items-center">
                      <input type="radio" name="category" value={category.id} checked={selectedCategory === category.id} onChange={e => setSelectedCategory(e.target.value)} className="mr-2 text-neon-green focus:ring-neon-green" />
                      {category.name}
                    </label>)}
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <input type="range" min="0" max="500" value={priceRange[1]} onChange={e => setPriceRange([priceRange[0], parseInt(e.target.value)])} className="w-full" />
              </div>
            </div>
          </motion.div>
          ...
          <div className="lg:w-3/4">
            {/* Controls */}
            <motion.div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4" initial={{
            y: -20,
            opacity: 0
          }} animate={{
            y: 0,
            ...
            delay: 0.2
              ...
              <div className="flex items-center gap-4">
                <select value={sortBy} onChange={e => setSortBy(e.target.value)} className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-neon-green">
                ...
                <div className="flex border border-gray-300 rounded-lg overflow-hidden">
                  <button onClick={() => setViewMode('grid')} className={`p-2 ${viewMode === 'grid' ? 'bg-neon-green text-white' : 'bg-white text-gray-600'}`}>
                    <Grid className="w-4 h-4" />
                  </button>
                  <button onClick={() => setViewMode('list')} className={`p-2 ${viewMode === 'list' ? 'bg-neon-green text-white' : 'bg-white text-gray-600'}`}>
            ...
            {/* Products Grid */}
            <motion.div className={`grid gap-6 ${viewMode === 'grid' ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1'}`} initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
            ...
            delay: 0.3
              ...
              {filteredProducts.map((product, index) => <motion.div key={product.id} className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer" initial={{
              y: 50,
              opacity: 0
            }} animate={{
              y: 0,
              ...
              y: -5
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute top-4 right-4 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <motion.button className={`p-2 bg-white rounded-full shadow-lg transition-colors ${isInWishlist(product.id) ? 'bg-neon-pink text-white' : 'hover:bg-neon-pink hover:text-white'}`} whileHover={{
                    scale: 1.1
                  }} whileTap={{
                    scale: 0.9
                  }} onClick={e => {
                    ...
                    handleWishlistToggle(product);
                      ...
                      <motion.button className="p-2 bg-white rounded-full shadow-lg hover:bg-electric-indigo hover:text-white" whileHover={{
                    scale: 1.1
                  }} whileTap={{
                    scale: 0.9
                  }} onClick={e => {
                  ...
                  <div className="p-4">
                    ...
                    <motion.button className="w-full py-2 bg-gradient-neon text-white font-semibold rounded-lg opacity-0 group-hover:opacity-100 transition-opacity" whileHover={{
                  scale: 1.02
                }} whileTap={{
                  scale: 0.98
                }} onClick={e => {
            ...
            {/* No products found */}
            {filteredProducts.length === 0 && <motion.div className="text-center py-16" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
            duration: 0.6
              ...
              setPriceRange([0, 500]);
            }} className="bg-gradient-neon text-white px-6 py-3 rounded-lg font-semibold" whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.95
            }}>
