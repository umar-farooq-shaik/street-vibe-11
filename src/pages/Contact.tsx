      ...
      <div className="container mx-auto px-4 pt-24 pb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-2xl font-bold text-soft-black mb-6">Send us a Message</h2>
          ...
          >
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-soft-black">Email</h3>
                    <p className="text-gray-600">hello@streetvibe.com</p>
                  </div>
                </div>
                
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-electric-indigo/10 rounded-full flex items-center justify-center">
                    <Phone className="w-6 h-6 text-electric-indigo" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-soft-black">Phone</h3>
                    <p className="text-gray-600">+1 (555) 123-4567</p>
                  </div>
                </div>
                
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-neon-pink/10 rounded-full flex items-center justify-center">
                    <MapPin className="w-6 h-6 text-neon-pink" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-soft-black">Address</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <h3 className="text-xl font-bold text-soft-black mb-4">Business Hours</h3>
